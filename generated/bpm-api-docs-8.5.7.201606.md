...
>Retrieves a list of task instance entities obtained by using a query.
...
>Retrieves the number of task instance entities that meet specified criteria in a query
